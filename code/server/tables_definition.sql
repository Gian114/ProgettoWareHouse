...
CREATE TABLE IF NOT EXISTS SKU_ITEM (
    ...
    FOREIGN KEY(return_order_id) REFERENCES RETURN_ORDER(id) ON DELETE SET NULL,
    FOREIGN KEY(restock_order_id) REFERENCES RESTOCK_ORDER(id) ON DELETE SET NULL,
    FOREIGN KEY(internal_order_id) REFERENCES INTERNAL_ORDER(id) ON DELETE SET NULL
);
