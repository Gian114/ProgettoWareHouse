...
CREATE TABLE IF NOT EXISTS SKU (
    ...
    position_id INTEGER NOT NULL FOREIGN KEY REFERENCES POSITION(id)
);
...
CREATE TABLE IF NOT EXISTS TEST_RESULT (
    ...
    sku_item_rfid TEXT NOT NULL FOREIGN KEY REFERENCES SKU_ITEM(rfid),
    test_descriptor_id INTEGER NOT NULL FOREIGN KEY (test_descriptor_id) REFERENCES TEST_DESCRIPTOR(id)
);
...
CREATE TABLE IF NOT EXISTS RETURN_ORDER (
    ...
    returnDate TEXT,
    sku_item_rfid TEXT NOT NULL FOREIGN KEY REFERENCES SKU_ITEM(rfid),
    restock_order_id INTEGER NOT NULL FOREIGN KEY REFERENCES RESTOCK_ORDER(id)
);
